...
@section('content')
        ...
        <div class="card">
            <div class="card-body">
                <div class="form-group">
                    <table class="table table-striped table-bordered table-hover table-sm markTable">
                        <thead>
                            <tr>
                                <th class="p-2">Mark</th>
                                <th class="p-2">Date of mark</th>
    ...
    @push('scripts')
        <script src="{{ mix('js/marks_managment/marks_managment.js') }}"></script>
        <script type="text/javascript">
            var MARKS_API_INDEX = "{{ route('mark.api.index') }}"
            var MARK_DELETE = "{{route('mark.delete')}}"
        </script>
    @endpush
@endsection
